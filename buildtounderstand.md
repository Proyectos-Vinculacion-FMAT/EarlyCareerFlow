...
```mermaid
flowchart LR
    A["Definir y presentar\nuna idea (Pitch)"] --> B["Desarrollar prototipo\ncon apoyo de agentes de IA\n(cuidando calidad)"]
    B --> C["Refinar mediante\nretroalimentación y\nensayos de comunicación"]
...
```mermaid
gantt
    title Calendario del Módulo (tentativo)
    dateFormat YYYY-MM-DD
    axisFormat %b

    Herramientas Digitales      :milestone, m1, 2026-09-19, 1d
    Equipos Colaborativos       :milestone, m2, 2026-09-26, 1d
    Ship Standard               :milestone, m3, 2026-10-10, 1d
    Comunicación Efectiva       :active, m4, 2026-11-01, 30d
    Storytelling                :active, m5, 2026-12-01, 31d
```
